...
class ComposerAutoloaderInit108be68e4e2b97fed51d36a10eed0849
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInit108be68e4e2b97fed51d36a10eed0849::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequire108be68e4e2b97fed51d36a10eed0849($fileIdentifier, $file);
        }
 ...
 * @return void
 */
function composerRequire108be68e4e2b97fed51d36a10eed0849($fileIdentifier, $file)
{
