...
DROP
DATABASE IF EXISTS `dwes`;

-- Creamos la base de datos
CREATE
DATABASE  `dwes` DEFAULT CHARACTER SET UTF8MB4 COLLATE  utf8mb4_unicode_ci;
...
USE
`dwes`;
INSERT INTO `tienda` (`cod`, `nombre`, `tlf`)
VALUES (1, 'CENTRAL', '600100100'),
       (2, 'SUCURSAL1', '600100200'),
       (3, 'SUCURSAL2', NULL);

INSERT INTO `familia` (`cod`, `nombre`)
VALUES ('CAMARA', 'Cámaras digitales'),
       ('CONSOL', 'Consolas'),
...
VALUES ('3DSNG', NULL, 'Nintendo 3DS negro',
        ...
        '270.00', 'CONSOL'),
       ('ACERAX3950', NULL, 'Acer AX3950 I5-650 4GB 1TB W7HP',
        ...
        '410.00', 'ORDENA'),
       ('ARCLPMP32GBN', NULL, 'Archos Clipper MP3 2GB negro',
        ...
        '26.70', 'MP3'),
       ('BRAVIA2BX400', NULL, 'Sony Bravia 32IN FULLHD KDL-32BX400',
        ...
        '356.90', 'TV'),
       ('EEEPC1005PXD', NULL, 'Asus EEEPC 1005PXD N455 1 250 BL',
       ...
       ('HPMIN1103120', NULL, 'HP Mini 110-3120 10.1LED N455 1GB 250GB W7S negro',
        ...
        '270.00', 'NETBOK'),
       ('IXUS115HSAZ', NULL, 'Canon Ixus 115HS azul',
       ...
       ('KSTDT101G2', NULL, 'Kingston DataTraveler 16GB DT101G2 USB2.0 negro',
        ...
        '19.20', 'MEMFLA'),
       ('KSTDTG332GBR', NULL, 'Kingston DataTraveler G3 32GB rojo',
        'Características:\r\n\r\nTipo de producto Unidad flash USB\r\nCapacidad almacenamiento32GB\r\nAnchura 58.3 mm\r\nProfundidad 23.6 mm\r\nAltura 9.0 mm\r\nPeso 12 g\r\nColor incluido RED\r\nTipo de interfaz USB',
        '40.00', 'MEMFLA'),
       ('KSTMSDHC8GB', NULL, 'Kingston MicroSDHC 8GB',
        ...
        '10.20', 'MEMFLA'),
       ('LEGRIAFS306', NULL, 'Canon Legria FS306 plata',
       ...
       ('LGM237WDP', NULL, 'LG TDT HD 23 M237WDP-PC FULL HD',
        ...
        '186.00', 'TV'),
       ('LJPROP1102W', NULL, 'HP Laserjet Pro Wifi P1102W',
        ...
        '99.90', 'IMPRES'),
       ('OPTIOLS1100', NULL, 'Pentax Optio LS1100',
        ...
        '104.80', 'CAMARA'),
       ('PAPYRE62GB', NULL, 'Lector ebooks Papyre6 con SD2GB + 500 ebooks',
       ...
       ('PBELLI810323', NULL, 'Packard Bell I8103 23 I3-550 4G 640GB NVIDIAG210',
        ...
        '761.80', 'ORDENA'),
       ('PIXMAIP4850', NULL, 'Canon Pixma IP4850',
        ...
        '97.30', 'IMPRES'),
       ('PIXMAMP252', NULL, 'Canon Pixma MP252',
        ...
        '41.60', 'MULTIF'),
       ('PS3320GB', NULL, 'PS3 con disco duro de 320GB',
        'Este Pack Incluye:\r\n- La consola Playstation 3 Slim Negra 320GB\r\n- El juego Killzone 3\r\n', '380.00',
        'CONSOL'),
       ('PWSHTA3100PT', NULL, 'Canon Powershot A3100 plata',
        ...
        '101.40', 'CAMARA'),
       ('SMSGCLX3175', NULL, 'Samsung CLX3175',
       ...
       ('SMSN150101LD', NULL, 'Samsung N150 10.1LED N450 1GB 250GB BAT6 BT W7 R',
        ...
        '260.60', 'NETBOK'),
       ('SMSSMXC200PB', NULL, 'Samsung SMX-C200PB EDC ZOOM 10X',
        ...
        '127.20', 'VIDEOC'),
       ('STYLUSSX515W', NULL, 'Epson Stylus SX515W',
        ...
        '77.50', 'MULTIF'),
       ('TSSD16GBC10J', NULL, 'Toshiba SD16GB Class10 Jewel Case',
        ...
        '32.60', 'MEMFLA'),
       ('ZENMP48GB300', NULL, 'Creative Zen MP4 8GB Style 300',
